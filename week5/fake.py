...
def calc_slicetimes(filenames, TR):
    ...
    for f in filenames:
       ...
       slice_order = list(reversed(range(0, n_slices, 2) + range(1, n_slices, 2)))
...
work_dir = '/scratch/PSB6351_2017/students/salo/working_fake/'
sink_dir = '/scratch/PSB6351_2017/students/salo/data_fake/'
err_dir = '/scratch/PSB6351_2017/students/salo/crash_fake/'
